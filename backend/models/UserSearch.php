...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'group', 'active', 'login_attempts', 'updated_by', 'created_by', 'created_at', 'updated_at'], 'integer'],
            [['first_name', 'last_name', 'phone', 'email', 'auth_key', 'password_hash', 'password_reset_token', 'verification_token', 'ip_address', 'man_number', 'expiry_date', 'username', 'last_login', 'other_name', 'title'], 'safe'],
        ];
    }
