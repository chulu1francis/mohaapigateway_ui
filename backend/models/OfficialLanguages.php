...
/**
 * This is the model class for table "official_languages".
 *
 * @property int $id
 ...
 */
class OfficialLanguages extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Organisations::class, ['official_language' => 'id']);
    }
