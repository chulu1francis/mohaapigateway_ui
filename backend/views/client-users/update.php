...
$this->title = 'Update Client Users: ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Client Users', 'url' => ['index']];
            ...
            <div class="col-auto">
                <div class="col-auto ms-3 ps-3 " id="emails-actions">
                    <div class="btn-group btn-group-sm">
                        <?=
                        Html::a('<span class="fas fa-arrow-left me-1" data-fa-transform="shrink-3"></span> Back to Client users', ['client-users/index'], ["class" => 'btn ' . Yii::$app->params['btnClassFalcon'] . ' btn-sm']);
                        ?>
                    </div>
                </div>
            </div>
