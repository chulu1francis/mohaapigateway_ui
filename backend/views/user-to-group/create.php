...
$this->title = 'Attach user to group';
$this->params['breadcrumbs'][] = ['label' => 'User to group attachments', 'url' => ['index']];
            ...
            <div class="col-auto">
                <div class="col-auto ms-3 ps-3 " id="emails-actions">
                    <div class="btn-group btn-group-sm">
                        <?=
                        Html::a('<span class="fas fa-arrow-left me-1" data-fa-transform="shrink-3"></span> Back', ['user-to-group/index'], ["class" => 'btn btn-falcon-default btn-sm']);
                        ?>
