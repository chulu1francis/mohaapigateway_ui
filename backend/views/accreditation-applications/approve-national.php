        ...
        <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-white dark__bg-dark">
            <div class="row">            
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4>Accreditation officer recommedation</h4>
                            <hr>
                            <?php
                            echo DetailView::widget([
                                ...
                                'attributes' => [
                                    ...
                                    [
                                        ...
                                        'label' => 'Date reviewed',
                                        'value' => function () use ($accreditationApprovals) {
                                            return date('d F, Y H:is', strtotime($accreditationApprovals->approval_date_accreditation_officer));
                                        }
                                    ],
                                    [
                        ...
                        <div class="col-lg-12 mt-3">
                            <h4>Approval</h4>
                            <p>Take action below based on the above recommedation</p>
                            <hr>
                            <?php
                            $form = ActiveForm::begin(
                                            ['action' => 'approve-national?id=' . $model->id,]);
                            ?>
