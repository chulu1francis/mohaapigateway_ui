...
$consultativeApplication = AccreditationApplications::find()->
                ...
                ->andWhere(['type' => "Consultative"])->one();
?>
            ...
            <div class="col-auto">
                <div class="col-auto ms-3 ps-3 " id="emails-actions">
                    <div class="btn-group btn-group-sm">
                        <?php
                        if (!empty($contactPersons) && !empty($areasOfExpertise) && !empty($organisationRegistrationDetails)) {
                            if (empty($consultativeApplication)) {
                                echo Html::a('<span class="fas fa-plus me-1" data-fa-transform="shrink-3"></span> Apply for consultative', ['create'],
                                        [
                ...
                ['class' => ActionColumn::className(),
                    ...
                    'buttons' => [
                        ...
                        'submit' => function ($url, $model) {
                            if ($model->status ==AccreditationApplications::NOT_SUBMITTED) {
                                return Html::a(
                                                '<span class="fas fa-paper-plane"></span>', ['submit-application', 'id' => $model->id, 'type' => 0], [
